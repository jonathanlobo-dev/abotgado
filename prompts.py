...
- Cita los artículos que respondan DIRECTAMENTE a la pregunta: normalmente 2 a 3. Si UN solo artículo responde de fondo, cítalo solo — no rellenes para llegar a un número. 4 es el máximo; 5+ es ruido. Calidad sobre cantidad.
