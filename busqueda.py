...
ARTICULOS_CLAVE = {
    ...
    "negocio_casa": {
        "keywords": ["bodega en casa", "negocio en casa", "poner una bodega",
                     ...
                     "hot dog", "hotdog", "hamburguesas", "hamburguesa",
                     "empanadas", "empanada", "arepas", "arepa",
                     "tequeños", "tequeño", "teques",
                     "desayunos", "desayuno", "almuerzos", "almuerzo",
                     "cenas", "meriendas", "pasapalos",
