...
async def ayuda(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if es_admin(user_id):
        texto += (
            ...
            "<b>Límites de consulta:</b>\n"
            "/ver_planes — Config actual de los planes\n"
            "/set_plan PLAN N PERIODO — Cambiar límite (ej: /set_plan gratis 3 semanal)\n"
            "/set_user_limit ID N PERIODO — Override por usuario\n"
            "/quitar_user_limit ID — Quitar override de usuario\n\n"
            "<b>Planes:</b>\n"
